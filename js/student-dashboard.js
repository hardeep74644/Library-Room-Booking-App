...
function displayAvailableRooms(rooms, date, startTime, endTime) {
    ...
    if (rooms.length === 0) {
        roomsList.innerHTML = '<p style="text-align: center; color: #999;">No rooms found matching your criteria.</p>';
